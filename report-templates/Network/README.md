...
| `Faction2_INT_EXTNWPT_Template_Mapping.md` | Section-by-section mapping, the 27 user-defined fields, the remaining gaps, and the v1 to v6 change history with how each version was verified. |
...
| `samples/Sample_Network_Report_v6*` | A report generated from v6 on a simulated engagement: 3 findings, and a 13-row iSec checklist answered 8 PASS / 5 FAIL. Both charts, the CVSS links and the scope tables in it were verified against those numbers. |
